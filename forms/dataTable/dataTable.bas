...
// an array of arrays. One array for each row.
 var data1 = [
    ...
    ["Unity Butler", "Marketing Designer", "San Francisco", "5384", "2009/12/09", "$85,675"],
        ["Allie Joas", "Software Developer", "Paris", "8223", "2020/06/08", "$224,922"],
    ["Daniela Bresler", "Digital Marketing Manager", "New York", "0922", "2020/08/09", "$200,622"]
];
...
Function DataTable_onshow()
  modAlert.toggle()
  modAlert.value = ("We added Allie Joas and Daniela Bresler! </br> The data inputed is: Allie Joas, Software Developer, Paris, 8223, 2020/06/08, $224,922 </br> Daniela Bresler, Digital Marketing Manager, New York, 0922, 2020/08/09, $200,622")
End Function